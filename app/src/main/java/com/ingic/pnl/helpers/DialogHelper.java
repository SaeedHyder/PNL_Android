...
public class DialogHelper {
    ...
    public Dialog initlogout(int layoutID, View.OnClickListener onokclicklistener, View.OnClickListener oncancelclicklistener, String title, String message) {
        ...
        AnyTextView messageView = (AnyTextView) dialog.findViewById(R.id.txt_logout_text);
        messageView.setText(message);
        AnyTextView headingView = (AnyTextView) dialog.findViewById(R.id.txt_Logout);
